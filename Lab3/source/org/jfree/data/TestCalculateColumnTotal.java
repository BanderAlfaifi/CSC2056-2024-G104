...
public class TestCalculateColumnTotal {
	...
	public void setUp() throws Exception {
		...
		testValues3.addValue(3, 0, 2); 
		testValues3.addValue(4, 0, 3);
		testValues3.addValue(5, 0, 4);
		
		testValues3.addValue(4, 1, 0); 
		testValues3.addValue(5, 1, 1);
		testValues3.addValue(6, 1, 2); 
		testValues3.addValue(7, 1, 3);
		testValues3.addValue(8, 1, 4);
	}
    ...
    public void test10() {
	    try {
	    	int colIndex = 0;
	        assertEquals("The output should be 4.0", 4.0 , DataUtilities.calculateColumnTotal(values2DOneElementNull, colIndex), 0.0000001d);
	    } catch (Exception e) {
	        fail("An error occurred: " + e.getMessage());
	    }
    }
