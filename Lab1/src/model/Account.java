...
public String toString() {
	return "Account [account_number=" + account_number + ", username_of_account_holder=" + username_of_account_holder
			+ ", account_type=" + account_type + ", account_opening_date=" + account_opening_date + "]";
}
